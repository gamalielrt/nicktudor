...
function displayProjects() {
    ...
    for (let i=0; i<=7; i++ ) {
        ...
        document.getElementById("projectscontainer").innerHTML += '<div class = "project" id ="project'+ i +'" ><img class ="projectThumbImg" id = "projectThumbImg'+ i +'" src ="assets/projects/projectthumbnails/'+ projectList.projects[i].image +'" onload = "resizeMainsite()"></div>';
        ...
        if (deviceType.includes("computer") || window.innerWidth > 550) {
            ...
            switch (projectList.projects[i].position) {
                case('full') :
                    ...
                    document.getElementById("projectThumbImg"+ i).style.paddingLeft = Math.floor(Math.random() * 15) + 5 + '%';
                ...
                case('left') :
                    ...
                    document.getElementById("projectThumbImg"+ i).style.paddingLeft = Math.floor(Math.random() * 10) + 1 + '%';
                ...
                case('right') :
                    ...
                    document.getElementById("projectThumbImg"+ i).style.width = '50%';
                    document.getElementById("projectThumbImg"+ i).style.paddingLeft = Math.floor(Math.random() * 30) + 20 + '%';
